...
mod tests {
    ...
    rpc_test! (
        ParityAccounts :   parity_kill_account,  &"0x9b776baeaf3896657a9ba0db5564623b3e0173e0".parse::<Address>().unwrap(), "123456789"
    ...
    rpc_test! (
        ...
        Value::String("0xE43eD16390bd419d48B09d6E2aa20203D1eF93E1".into()) => "0xE43eD16390bd419d48B09d6E2aa20203D1eF93E1".parse::<Address>().unwrap()
    );
    ...
    rpc_test! (
        ...
        Value::String("0x9b776Baeaf3896657A9ba0db5564623B3E0173e0".into()) => "0x9b776Baeaf3896657A9ba0db5564623B3E0173e0".parse::<Address>().unwrap()
    );
    ...
    rpc_test! (
        ...
        Value::String("0x4C8aB9d3e938285776d6717d7319F6a9B1d809DD".into()) => "0x4C8aB9d3e938285776d6717d7319F6a9B1d809DD".parse::<Address>().unwrap()
    );

    rpc_test! (
        ParityAccounts :   parity_remove_address,  &"0x9b776baeaf3896657a9ba0db5564623b3e0173e0".parse::<Address>().unwrap()
