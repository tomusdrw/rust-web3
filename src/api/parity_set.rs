...
impl<T: Transport> ParitySet<T> {
    ...
    pub fn parity_set_engine_signer(&self, address: &Address, password: &str) -> CallFuture<bool, T::Out> {
    ...
    pub fn parity_set_extra_data(&self, data: &H256) -> CallFuture<bool, T::Out> {
